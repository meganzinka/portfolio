	...
	return (
		<div>
			...
			<iframe
				...
				allowfullscreen
			/>
            <button onClick ={showDescription}>View Project Description</button><a target="_blank" href="https://github.com/tMinusZiro/ad-magic.git"><button>GitHub Repository</button></a>
